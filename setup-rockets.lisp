...
(set 'table1 "CREATE TABLE Posts (Id INTEGER PRIMARY KEY, PosterId TEXT, PostDate DATE, PostSubject TEXT, PostContent TEXT, PostComments INTEGER, PostType TEXT, PostViews INTEGER, PostPoll TEXT, PostLastAuthor TEXT, PostLastDate INTEGER)")
...
; set the default individual page configuration
(set 'RocketsConfig:IndividualPageType 0)
