...
(displayln "<br><br><br>")
(displayln "<td width=250>Email (This is your User Name):</td><td><input type='text' name='e'><td>")
(if (= error-messages "noemail") 
	(display-error "You must enter an email address."))
(displayln "</td></tr>")
; Password
(displayln "<tr><td width=250>Password:</td><td><input type='password' name='p'><td>")
(if (= error-messages "nopw") 
	(display-error "You must enter a password."))
(displayln "</td></tr>")
(displayln "<tr><td width=250>Confirm password:</td><td><input type='password' name='c'><td>")
(if (= error-messages "pwmatch") 
	(display-error "Passwords did not match!"))
(displayln "</td></tr>")
; Display name
(displayln "<tr><td width=250>Display name:</td><td><input type='text' name='u'><td>")
...
(if (= error-messages "noname") 
	(display-error "You must enter a display name."))
(displayln "</td></tr>")
